...
exports.String = exports.List = exports.Tuple = exports.Option = exports.These = void 0;
...
const Option = function (__exports) {
  const option = __exports.option = function (def, f, x) {
    return function (option_1) {
      return (0, _Option.defaultArg)(option_1, def);
    }(function (option_2) {
      return (0, _Option.defaultArg)(option_2, null, f);
    }(x));
  };
