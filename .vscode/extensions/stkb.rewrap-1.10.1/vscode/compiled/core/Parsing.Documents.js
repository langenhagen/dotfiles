...
let languages = (0, _Util.createAtom)((0, _List.ofArray)([lang("AutoHotkey", "ahk", ".ahk", (() => {
  ...
  return (0, _CurriedLambda.default)(function (settings_8) {
    return (0, _Parsing2.sourceCode)(commentParsers_7, settings_8);
  });
  ...
  return (0, _CurriedLambda.default)(function (settings_9) {
    return (0, _Parsing2.sourceCode)(commentParsers_8, settings_9);
  });
})()), lang("Elm", "", ".elm", (() => {
  ...
  return (0, _CurriedLambda.default)(function (settings_10) {
    return (0, _Parsing2.sourceCode)(commentParsers_9, settings_10);
  });
  ...
  return (0, _CurriedLambda.default)(function (settings_11) {
    return (0, _Parsing2.sourceCode)(commentParsers_10, settings_11);
  });
})()), lang("Go", "", ".go", (() => {
  ...
  return (0, _CurriedLambda.default)(function (settings_14) {
    return (0, _Parsing2.sourceCode)(commentParsers_11, settings_14);
  });
})()), lang("Git commit", "git-commit", "tag_editmsg", (0, _CurriedLambda.default)(_Parsing4.markdown)), lang("GraphQL", "", ".graphql|.gql", configFile), lang("Groovy", "", ".groovy", _Parsing2.java), lang("Haskell", "", ".hs", (() => {
  ...
  const commentParsers_13 = (0, _List.ofArray)([(0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.javadoc, ["\\*?", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.customLine)(_Parsing5.javadoc, "//[/!]"), _Parsing2.cLine, (0, _Parsing2.line)("#")]);
  return (0, _CurriedLambda.default)(function (settings_17) {
    return (0, _Parsing2.sourceCode)(commentParsers_13, settings_17);
  });
  ...
  const commentParsers_18 = (0, _List.ofArray)([(0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.javadoc, ["\\*", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.line)("(?://|#)")]);
  ...
  const commentParsers_19 = (0, _List.ofArray)([(0, _Parsing2.customLine)(_Parsing5.psdoc, "#"), (0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.psdoc, ["", ""], ["<#", "#>"])]);
  return (0, _CurriedLambda.default)(function (settings_25) {
    return (0, _Parsing2.sourceCode)(commentParsers_19, settings_25);
  });
})()), lang("Prolog", "", "", (() => {
  ...
  return (0, _CurriedLambda.default)(function (settings_26) {
    return (0, _Parsing2.sourceCode)(commentParsers_20, settings_26);
  });
  ...
  return (0, _CurriedLambda.default)(function (settings_27) {
    return (0, _Parsing2.sourceCode)(commentParsers_21, settings_27);
  });
  ...
  return (0, _CurriedLambda.default)(function (settings_28) {
    return (0, _Parsing2.sourceCode)(commentParsers_22, settings_28);
  });
})()), lang("PureScript", "", ".purs", (() => {
  const commentParsers_23 = (0, _List.ofArray)([(0, _Parsing2.line)("--\\s*\\|"), (0, _Parsing2.line)("--"), (0, _Parsing2.block)(["{-\\s*\\|?", "-}"])]);
  return (0, _CurriedLambda.default)(function (settings_29) {
    return (0, _Parsing2.sourceCode)(commentParsers_23, settings_29);
  });
})()), lang("Python", "", ".py", (() => {
  const commentParsers_24 = (0, _List.ofArray)([(0, _Parsing2.line)("#"), (0, _Parsing2.block)(["([Bb][Rr]?|[Ff][Rr]?|[Rr][BbFf]?|[Uu])?\"\"\"", "\"\"\""]), (0, _Parsing2.block)(["([Bb][Rr]?|[Ff][Rr]?|[Rr][BbFf]?|[Uu])?'''", "'''"])]);
