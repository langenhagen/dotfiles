...
function ignoreFirstLine(otherParser, settings, _arg1) {
  ...
  }((0, _CurriedLambda.default)(otherParser)(settings)($var1))), (0, _Nonempty.singleton)(headBlock));
}
...
const dartdoc = (0, _CurriedLambda.default)((() => {
  ...
  const sectionParser = function (_arg1, settings, arg20_) {
    return ignoreFirstLine((0, _CurriedLambda.default)(_Parsing.markdown), settings, arg20_);
  };
...
const psdoc = (0, _CurriedLambda.default)((() => {
  ...
  const exampleSection = function (settings, lines) {
    ...
    const sectionParser = function (_arg1, settings_1, arg20_) {
      return ignoreFirstLine((0, _CurriedLambda.default)(_Parsing.markdown), settings_1, arg20_);
    };
