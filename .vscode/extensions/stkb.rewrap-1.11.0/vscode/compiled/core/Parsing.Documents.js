...
let languages = (0, _Util.createAtom)((0, _List.ofArray)([lang("AsciiDoc", "", ".adoc|.asciidoc", (0, _CurriedLambda.default)(plainText)), lang("AutoHotkey", "ahk", ".ahk", (() => {
...
})()), lang("Bikeshed", "", ".bs", (0, _CurriedLambda.default)(_Parsing4.markdown)), lang("C/C++", "c|c++|cpp", ".c|.cpp|.h", _Parsing2.java), lang("C#", "csharp", ".cs", (() => {
  const commentParsers_3 = (0, _List.ofArray)([(0, _Parsing2.customLine)(_Parsing2.html, "///"), _Parsing2.cLine, (0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.javadoc, ["\\*?", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock]);
  ...
  const commentParsers_7 = (0, _List.ofArray)([(0, _Parsing2.customLine)(_Parsing5.dartdoc, "///"), _Parsing2.cLine, (0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.dartdoc, ["\\*", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock]);
  ...
  const commentParsers_11 = (0, _List.ofArray)([(0, _CurriedLambda.default)(_Parsing2.customBlock)((0, _CurriedLambda.default)(_Parsing5.godoc), ["", ""], _Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.customLine)((0, _CurriedLambda.default)(_Parsing5.godoc), "//"), _Parsing2.cLine]);
  return (0, _CurriedLambda.default)(function (settings_15) {
    return (0, _Parsing2.sourceCode)(commentParsers_11, settings_15);
  });
  ...
  const commentParsers_12 = (0, _List.ofArray)([(0, _Parsing2.block)(["{{!--", "--}}"]), (0, _Parsing2.block)(["{{!", "}}"]), (0, _Parsing2.block)(["<!--", "-->"])]);
  return (0, _CurriedLambda.default)(function (settings_17) {
    return (0, _Parsing2.sourceCode)(commentParsers_12, settings_17);
  });
})()), lang("Haskell", "", ".hs", (() => {
  const commentParsers_13 = (0, _List.ofArray)([(0, _Parsing2.line)("--"), (0, _Parsing2.block)(["{-\\s*\\|?", "-}"])]);
  ...
  const commentParsers_14 = (0, _List.ofArray)([(0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.javadoc, ["\\*?", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.customLine)(_Parsing5.javadoc, "//[/!]"), _Parsing2.cLine, (0, _Parsing2.line)("#")]);
  ...
  const commentParsers_15 = (0, _List.ofArray)([(0, _Parsing2.line)("[#;]")]);
  ...
  return (0, _CurriedLambda.default)(function (settings_22) {
    return (0, _Parsing2.sourceCode)(commentParsers_16, settings_22);
  });
})()), lang("Less", "", ".less", _Parsing2.java), lang("Lua", "", ".lua", (() => {
  const commentParsers_17 = (0, _List.ofArray)([(0, _Parsing2.block)(["--\\[\\[", "\\]\\]"]), (0, _Parsing2.line)("--")]);
  ...
  const commentParsers_18 = (0, _List.ofArray)([(0, _Parsing2.line)("%(?![%{}])"), (0, _Parsing2.block)(["%\\{", "%\\}"])]);
  return (0, _CurriedLambda.default)(function (settings_25) {
    return (0, _Parsing2.sourceCode)(commentParsers_18, settings_25);
  });
})()), lang("Objective-C", "", ".m|.mm", _Parsing2.java), lang("Perl", "perl6", ".p6|.pl|.pl6|.pm|.pm6", configFile), lang("PHP", "", ".php", (() => {
  const commentParsers_19 = (0, _List.ofArray)([(0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.javadoc, ["\\*", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.line)("(?://|#)")]);
  ...
  const commentParsers_20 = (0, _List.ofArray)([(0, _Parsing2.customLine)(_Parsing5.psdoc, "#"), (0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.psdoc, ["", ""], ["<#", "#>"])]);
  return (0, _CurriedLambda.default)(function (settings_27) {
    return (0, _Parsing2.sourceCode)(commentParsers_20, settings_27);
  });
})()), lang("Prolog", "", "", (() => {
  const commentParsers_21 = (0, _List.ofArray)([(0, _CurriedLambda.default)(_Parsing2.customBlock)(_Parsing5.javadoc, ["\\*?", " * "], _Parsing2.javadocMarkers), _Parsing2.cBlock, (0, _Parsing2.line)("%[%!]?")]);
  ...
  const commentParsers_22 = (0, _List.ofArray)([_Parsing2.cLine]);
  ...
  const commentParsers_24 = (0, _List.ofArray)([(0, _Parsing2.line)("--\\s*\\|"), (0, _Parsing2.line)("--"), (0, _Parsing2.block)(["{-\\s*\\|?", "-}"])]);
  ...
  const commentParsers_26 = (0, _List.ofArray)([(0, _Parsing2.line)("#"), (0, _Parsing2.block)(["=begin", "=end"])]);
  return (0, _CurriedLambda.default)(function (settings_34) {
    return (0, _Parsing2.sourceCode)(commentParsers_26, settings_34);
  });
})()), lang("Rust", "", ".rs", (() => {
  const commentParsers_27 = (0, _List.ofArray)([(0, _Parsing2.line)("\\/\\/(?:\\/|\\!)?")]);
  ...
  const commentParsers_28 = (0, _List.ofArray)([(0, _Parsing2.line)("--"), _Parsing2.cBlock]);
  return (0, _CurriedLambda.default)(function (settings_36) {
    return (0, _Parsing2.sourceCode)(commentParsers_28, settings_36);
  });
})()), lang("Swift", "", ".swift", _Parsing2.java), lang("Tcl", "", ".tcl", configFile), lang("TOML", "", ".toml", configFile), lang("TypeScript", "typescriptreact", ".ts|.tsx", _Parsing2.java), lang("Verilog/SystemVerilog", "systemverilog|verilog", ".sv|.svh|.v|.vh|.vl", _Parsing2.java), lang("XML", "xsl", ".xml|.xsl", _Parsing2.html), lang("YAML", "", ".yaml|.yml", (0, _CurriedLambda.default)(function (settings_37) {
  const comments = (0, _Parsing2.line)("#{1,3}", settings_37);
  return (0, _Parsing.repeatToEnd)((0, _Parsing.takeUntil)(comments, plainText(settings_37)));
}))]));
...
function addCustomLanguage(name, markers) {
  ...
  const maybeBlock = (0, _Option.defaultArg)(markers.block, null, $var5 => ($var4 => (0, _CurriedLambda.default)(_Parsing2.block)($var4))(function (tupledArg) {
    return _Extensions.Tuple.map(escape, tupledArg[0], tupledArg[1]);
  }($var5)));
...
function select(file) {
  return (0, _CurriedLambda.default)((0, _CurriedLambda.default)(function (x) {
    return _Extensions.Option.option(plainText, _Parsing3.LanguageModule.parser.bind(_Parsing3.LanguageModule), x);
